    ...
    "en-US": {
      ...
      explorer: {
        ...
        meta: {
          ...
          selectedFlowlineId: "Current Flowline",
          ...
          selectedFlowlinePreviewCaption: "Surface, ice base, and bedrock sampled along the selected flowline.",
          status: "Status",
          invertedFriction:
            "Inverted Friction",
    ...
    "zh-CN": {
      ...
      explorer: {
        ...
        meta: {
          ...
          selectedFlowlinePreviewCaption: "剪影展示所选流线沿程采样的冰表、冰底与基岩形态。",
          status: "状态",
